...
/// <seealso>Adams, O. S. (1925), "Elliptic Functions Applied to Conformal World Maps", US Coast and Geodetic Survey Special Publication No. 167.</seealso>
/// <seealso>Peirce, C. S. (1879), "A Quincuncial Projection of the Sphere", American Journal of Mathematics, 2(4), 394-397.</seealso>
...
internal abstract class AdamsProjectionBase : MapProjection
{
    ...
    {
        double temp = x;
        x = ProjectionConstants.OneOverSqrt2 * (x - y);
        y = ProjectionConstants.OneOverSqrt2 * (temp + y);
    }
