...
public sealed class EngineeringCoordinateSystem : CoordinateSystem
{
    ...
    /// <returns>A new <see cref="EngineeringCoordinateSystem"/> with updated authority metadata.</returns>
    public new EngineeringCoordinateSystem WithAuthority(string authority, long code) => InfoAuthorityCloneHelper.CloneWithAuthority(this, authority, code);

    /// <summary>
    /// Creates a copy of this coordinate system with an updated name.
    /// </summary>
    /// <param name="name">Replacement name.</param>
    /// <returns>A new <see cref="EngineeringCoordinateSystem"/> with the updated name.</returns>
    public new EngineeringCoordinateSystem WithName(string name) => InfoAuthorityCloneHelper.CloneWithName(this, name);
