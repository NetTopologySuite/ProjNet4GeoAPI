...
public sealed class TimeUnit : Info, IUnit
{
    ...
    /// <returns>A new <see cref="TimeUnit"/> with updated authority metadata.</returns>
    public new TimeUnit WithAuthority(string authority, long code) => InfoAuthorityCloneHelper.CloneWithAuthority(this, authority, code);

    /// <summary>
    /// Creates a copy of this unit with an updated name.
    /// </summary>
    /// <param name="name">Replacement name.</param>
    /// <returns>A new <see cref="TimeUnit"/> with the updated name.</returns>
    public new TimeUnit WithName(string name) => InfoAuthorityCloneHelper.CloneWithName(this, name);
