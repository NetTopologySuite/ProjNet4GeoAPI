...
public sealed class TemporalCoordinateSystem : CoordinateSystem
{
    ...
    /// <returns>A new <see cref="TemporalCoordinateSystem"/> with updated authority metadata.</returns>
    public new TemporalCoordinateSystem WithAuthority(string authority, long code) => InfoAuthorityCloneHelper.CloneWithAuthority(this, authority, code);

    /// <summary>
    /// Creates a copy of this coordinate system with an updated name.
    /// </summary>
    /// <param name="name">Replacement name.</param>
    /// <returns>A new <see cref="TemporalCoordinateSystem"/> with the updated name.</returns>
    public new TemporalCoordinateSystem WithName(string name) => InfoAuthorityCloneHelper.CloneWithName(this, name);
